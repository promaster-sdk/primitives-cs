...
internal class Scanner {
	...
	static readonly IDictionary<object,object> start; // maps first token character to start state
...
//	}
	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 4:
				if (ch == '.' || ch == '_' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 5;}
				else {goto case 0;}
			case 5:
				recEnd = pos; recKind = 2;
				if (ch == '.' || ch == '_' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 5;}
